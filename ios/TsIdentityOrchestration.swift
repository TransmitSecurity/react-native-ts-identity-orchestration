...
extension TsIdentityOrchestration: TSIdoDelegate {
  ...
  private func idoJourneyStepIdToString(_ journeyStepId: IdentityOrchestration.TSIdoJourneyActionType?) -> String? {
    ...
    case .emailValidation: return "emailValidation"
    case .smsValidation: return "smsValidation"
    case .deleteMobileBiometrics: return "deleteMobileBiometrics"
    case .totpRegistration: return "totpRegistration"
